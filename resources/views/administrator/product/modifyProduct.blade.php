...
@section('content')
    ...
    <section class="row">
        ...
        <div class="col-lg-8 my-5">
            ...
            <h5 class="title_form_admin">EDICIÓN DE PRODUCTO</h5>

            <form method="POST" action="{{route('product.update', $producto)}}" enctype="multipart/form-data" class="form_admin">
